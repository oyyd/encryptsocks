...
function createClientToDst(connection, data, password, method, onConnect, onDestroy, isLocalConnected) {
  var connectFunc = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : _net.connect;
  ...
  var clientToDst = connectFunc(clientOptions, onConnect, data.slice(0, dstInfo.totalLength));
