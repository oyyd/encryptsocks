...
function handleRequest(connection, data, remoteAddr, remotePort, password, method, dstInfo, onConnect) {
  var cmd = data[1];
  ...
  connection.on('data', function (data) {
    switch (stage) {
      ...
      case 1:
        ...
        tmp = handleRequest(connection, data, config.server, config.server_port, config.password, config.method, dstInfo, function () {
