...
function createLogger() {
  var level = arguments.length <= 0 || arguments[0] === undefined ? DEFAULT_LEVEL : arguments[0];
  var logName = arguments[1];
  var willLogToConsole = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
